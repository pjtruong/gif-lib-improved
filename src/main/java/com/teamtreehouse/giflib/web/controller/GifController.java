...
public class GifController {
    ...
    public String favorites(Model model) {
        ...
        List<Gif> faves = gifService.findFavorite();

        model.addAttribute("gifs",faves);
        model.addAttribute("username","Peter Truong"); // Static username
    ...
    public String searchResults(@RequestParam String q, Model model) {
        ...
        List<Gif> gifs = gifService.findSearch(q);

        model.addAttribute("gifs",gifs);
        model.addAttribute("username","Peter Truong");
        return "gif/search";
    }
}